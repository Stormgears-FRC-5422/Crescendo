/* This file was autogenerated at {12:54:39} - do not edit it - any edits will be overwritten! */ 
package frc.robot;
...
public final class Constants {
	...
	public static final class Shooter {
		public static final int intakeID = StormProp.getInt("intakeID",0);
		public static final double intakeUpperMotorSpeed = StormProp.getNumber("intakeUpperMotorSpeed",0.0);
		public static final double intakeLowerMotorSpeed = StormProp.getNumber("intakeLowerMotorSpeed",0.0);
		public static final int followerID = StormProp.getInt("followerID",0);
		public static final double shootMotorSpeed = StormProp.getNumber("shootMotorSpeed",0.0);
		public static final int leaderID = StormProp.getInt("leaderID",0);
	}
