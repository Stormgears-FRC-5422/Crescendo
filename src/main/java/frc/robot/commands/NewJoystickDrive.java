...
public class NewJoystickDrive extends Command {
    ...
    public NewJoystickDrive(DrivetrainBase drivetrain,
    ...
    public void execute() {
        if (!turboSupplier.getAsBoolean()) {
            ...
            drivetrain.setDriveSpeedScale(Constants.Drive.driveSpeedScale);
        }
